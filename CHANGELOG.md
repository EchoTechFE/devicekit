...
- `@devicekit/frame`: add `input-mode` (`mobile`, `mobile-no-touch`, `desktop`, `desktop-touch`) for touch or mouse preview affordances, including the frame demo control and React prop.
